...
class SubCategoryController extends AbstractController
{
    ...
    {
        $subCategory = $paginator->paginate($subCategoryRepository->findAll(), $request->query->getInt('page', 1), 10);
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('sub_category_index', [], Response::HTTP_SEE_OTHER);
        }
